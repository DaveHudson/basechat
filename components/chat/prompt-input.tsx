  ...
  return (
    <>
      ...
      <textarea
        ...
        id="prompt"
        rows={1}
        className="block w-full rounded-md border-0 py-1.5 dark:bg-gray-900 text-gray-900 dark:text-gray-300 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
